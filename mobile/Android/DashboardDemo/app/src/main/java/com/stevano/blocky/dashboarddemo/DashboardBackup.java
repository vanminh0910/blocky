...
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Import", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.nav_gallery) {
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Gallery", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.nav_slideshow) {
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Slideshow", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.nav_manage) {
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Tools", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.nav_share) {
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Share", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.nav_send) {
//                    Toast.makeText(DashboardBackup.this, "Left Drawer - Send", Toast.LENGTH_SHORT).show();
//                }
//
...
//                    Toast.makeText(DashboardBackup.this, "Create Button", Toast.LENGTH_SHORT).show();
//                    Button btn = new Button(DashboardBackup.this);
...
//                    Toast.makeText(DashboardBackup.this, "Create Text", Toast.LENGTH_SHORT).show();
//                } else if (id == R.id.create_switch) {
//                    Toast.makeText(DashboardBackup.this, "Create Switch", Toast.LENGTH_SHORT).show();
//                }
//
...
//                    param = (RelativeLayout.LayoutParams) v.getLayoutParams();
//                    dx = motionEvent.getRawX() - param.leftMargin ;
//                    dy = motionEvent.getRawY() - param.topMargin ;
//                    mode = DRAG;
//                    break;
...
//                    lParams = new RelativeLayout.LayoutParams(marginParams);
