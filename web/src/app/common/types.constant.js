 ...
 */
export default angular.module('blocky.types', [])
    .constant('types',
        {
            serverErrorCode: {
                general: 2,
            ...
            baseApiUrl: "http://api.easytech.vn:3000/api/v1",
            entryPoints: {
                login: "http://api.easytech.vn:3000/api/v1/user/login",
                signup: "http://api.easytech.vn:3000/api/v1/user/signup"
            },
            id: {
